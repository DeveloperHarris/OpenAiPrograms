...
def determine_turn(turn, observation_n, j, total_sum, prev_total_sum, reward_n):
	#for every 15 iterations, sum the total observations, and take the average of the reward
	#if the reward is lower than 0, change the direction
	#if we go 15 iterations, and get a reward, we're doing something right
...
def main():
	...
	#client is the agent - decides what the keyboard/mouse actions
